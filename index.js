...
const STORAGE_KEY_HISTORY = 'pw_history_v20'; // 版本升级
...
async function openCreatorPopup() {
    ...
    if (savedState.resultText) {
        ...
        $('#pw-result-area').show();
        // 确保高度自适应
        const refineInput = $('#pw-refine-input')[0];
        if(refineInput) refineInput.style.height = (refineInput.scrollHeight)+'px';
    }
}
...
// ... renderWiBooks, addPersonaButton ... (保持之前逻辑)
window.pwExtraBooks = [];
